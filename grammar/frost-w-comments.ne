...
# #region model
model 
    -> _ "model"  _ iden _ %lCurly _ comment:? NL model_statments NL %rCurly _ comment:?
    {% ModelBlockConverter %}
...
model_statment 
    ->  pragma  comment:?
    |  iden _ data_type comment:? {% ModelStatementConverter %}
    |  iden _ data_type _ modifiers comment:? {% ModelStatementConverter %}
    |  comment
...
# #region type
type 
    -> _ "type" _ iden _ %lCurly _ comment:? NL type_statments NL %rCurly _ comment:?
    {% BlockConverter %}
...
# #region Enum
enum 
    -> _ "enum" _ iden _ %lCurly _ comment:? NL enum_statments NL %rCurly _ comment:?
    {% BlockConverter %}
...
enum_statment
    -> iden _ value_assignment:? comment:?
    {% StatementConverter %}
    | comment
